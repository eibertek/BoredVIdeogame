...
export const CHARACTERS: CharConfig[] = [
  {
    ...
    startTile: { x: 6, y: 12 },
    patrolPoints: [{ x: 6, y: 12 }, { x: 11, y: 12 }, { x: 11, y: 11 }, { x: 6, y: 11 }],
    dialogues: [
  ...
  },
  {
    ...
    startTile: { x: 24, y: 9 },
    patrolPoints: [{ x: 24, y: 9 }, { x: 31, y: 9 }, { x: 31, y: 17 }, { x: 22, y: 17 }],
    dialogues: [
  ...
  },
  {
    id: 'ellie',
    name: 'Ellie',
    role: 'Sales when are in the mood',
    ...
    startTile: { x: 15, y: 25 },
    patrolPoints: [{ x: 15, y: 25 }, { x: 14, y: 15 }, { x: 19, y: 9 }, { x: 15, y: 25 }],
    dialogues: [
  ...
  },
  {
    ...
    startTile: { x: 22, y: 17 },
    patrolPoints: [{ x: 22, y: 17 }, { x: 28, y: 17 }, { x: 28, y: 23 }, { x: 18, y: 23 }],
    dialogues: [
  ...
  },
  {
    ...
    name: 'Theo',
    role: 'IT Guy',
    description: '"Everything\'s fine, mon."',
    shirtColor: 0xef4444,
    hairColor:  0x2d1400,
    skinColor:  0xa07848,
    pantsColor: 0x1a4020,
    expression: 'happy',
    cardColor:  'from-green-900 to-yellow-700',
    startTile: { x: 20, y: 6 },
    patrolPoints: [
      { x: 20, y: 6 },
      { x: 32, y: 6 },
    ...
    dialogues: [
      'Everything is fine, mon. Have you tried the reset button?',
      'The WiFi is down? No worries, it always comes back.',
      'My keyboard is wireless. Like my soul, you know?',
      'I fixed the server. It was overheating — like bad vibes.',
      'You seen the gaming setup in aisle B? Irie stuff.',
    ],
  },
  {
    id: 'hamish',
